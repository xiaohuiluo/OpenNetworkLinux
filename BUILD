...
cc_library(
    name = "default_dependmodules_x",
    hdrs = [
        "packages/base/amd64/onlp/builds/onlp-platform-defaults/dependmodules.x",
    ],
    strip_include_prefix = "packages/base/amd64/onlp/builds/onlp-platform-defaults",
)
...
cc_library(
    ...
    copts = [
        ...
        "-DONLP_PLARFORM_DEFAULTS_CONFIG_AS_PLATFORM=0",
        "-fPIC",
    ],
    linkopts = ["-lpthread"],
    visibility = ["//visibility:public"],
...
cc_library(
    ...
    linkopts = [
        ...
        #LIBONLP_PLATFORM_DEFAULTS := ../onlp_platform_defaults/$(BUILD_DIR)/bin/libonlp_platform_defaults.so

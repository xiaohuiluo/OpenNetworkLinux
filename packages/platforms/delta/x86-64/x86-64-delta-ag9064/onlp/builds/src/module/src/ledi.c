...
static onlp_led_info_t linfo[] =
{
    { },
    {
        { ONLP_LED_ID_CREATE(LED_FAN), "FAN LED (FRONT PANEL)", 0, {}, ONLP_OID_STATUS_FLAG_PRESENT},
        ONLP_LED_CAPS_ON_OFF | ONLP_LED_CAPS_GREEN | ONLP_LED_CAPS_RED,
    },
    {
        { ONLP_LED_ID_CREATE(LED_SYS), "SYSTEM LED (FRONT PANEL)", 0, {}, ONLP_OID_STATUS_FLAG_PRESENT},
        ONLP_LED_CAPS_ON_OFF | ONLP_LED_CAPS_GREEN | ONLP_LED_CAPS_GREEN_BLINKING | ONLP_LED_CAPS_RED,
    },
    {
        { ONLP_LED_ID_CREATE(LED_PSU1), "PSU1 LED (FRONT PANEL)", 0, {}, ONLP_OID_STATUS_FLAG_PRESENT},
        ONLP_LED_CAPS_ON_OFF | ONLP_LED_CAPS_GREEN | ONLP_LED_CAPS_RED,
    },
    {
        { ONLP_LED_ID_CREATE(LED_PSU2), "PSU2 LED (FRONT PANEL)", 0, {}, ONLP_OID_STATUS_FLAG_PRESENT},
        ONLP_LED_CAPS_ON_OFF | ONLP_LED_CAPS_GREEN | ONLP_LED_CAPS_RED,
    },
    {
        { ONLP_LED_ID_CREATE(LED_FAN_TRAY_1), "FAN TRAY 1", 0, {}, ONLP_OID_STATUS_FLAG_PRESENT},
        ONLP_LED_CAPS_GREEN | ONLP_LED_CAPS_ORANGE,
    },
    {
        { ONLP_LED_ID_CREATE(LED_FAN_TRAY_2), "FAN TRAY 2", 0, {}, ONLP_OID_STATUS_FLAG_PRESENT},
        ONLP_LED_CAPS_GREEN | ONLP_LED_CAPS_ORANGE,
    },
    {
        { ONLP_LED_ID_CREATE(LED_FAN_TRAY_3), "FAN TRAY 3", 0, {}, ONLP_OID_STATUS_FLAG_PRESENT},
        ONLP_LED_CAPS_GREEN | ONLP_LED_CAPS_ORANGE,
    },
    {
        { ONLP_LED_ID_CREATE(LED_FAN_TRAY_4), "FAN TRAY 4", 0, {}, ONLP_OID_STATUS_FLAG_PRESENT},
        ONLP_LED_CAPS_GREEN | ONLP_LED_CAPS_ORANGE,
    },
};

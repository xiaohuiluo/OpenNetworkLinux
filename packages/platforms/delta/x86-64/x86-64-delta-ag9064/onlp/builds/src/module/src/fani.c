...
static onlp_fan_info_t linfo[] = 
{
    { }, /* Not used */
    { 
        { ONLP_FAN_ID_CREATE(FAN_1_ON_FAN_BOARD), "Chassis Fan 4 front", 0, {}, ONLP_OID_STATUS_FLAG_PRESENT},
        ONLP_FAN_DIR_UNKNOWN,
        ONLP_FAN_CAPS_GET_RPM | ONLP_FAN_CAPS_GET_PERCENTAGE, 0, 0,
    },
    {
        { ONLP_FAN_ID_CREATE(FAN_2_ON_FAN_BOARD), "Chassis Fan 3 front", 0, {}, ONLP_OID_STATUS_FLAG_PRESENT},
        ONLP_FAN_DIR_UNKNOWN,
        ONLP_FAN_CAPS_GET_RPM | ONLP_FAN_CAPS_GET_PERCENTAGE, 0, 0,
    },
    {
        { ONLP_FAN_ID_CREATE(FAN_3_ON_FAN_BOARD), "Chassis Fan 2 front", 0, {}, ONLP_OID_STATUS_FLAG_PRESENT},
        ONLP_FAN_DIR_UNKNOWN,
        ONLP_FAN_CAPS_GET_RPM | ONLP_FAN_CAPS_GET_PERCENTAGE, 0, 0,
    },
    {
        { ONLP_FAN_ID_CREATE(FAN_4_ON_FAN_BOARD), "Chassis Fan 1 front", 0, {}, ONLP_OID_STATUS_FLAG_PRESENT},
        ONLP_FAN_DIR_UNKNOWN,
        ONLP_FAN_CAPS_GET_RPM | ONLP_FAN_CAPS_GET_PERCENTAGE, 0, 0,
    },
    {
        { ONLP_FAN_ID_CREATE(FAN_6_ON_FAN_BOARD), "Chassis Fan 4 rear", 0, {}, ONLP_OID_STATUS_FLAG_PRESENT},
        ONLP_FAN_DIR_UNKNOWN,
        ONLP_FAN_CAPS_GET_RPM | ONLP_FAN_CAPS_GET_PERCENTAGE, 0, 0,
    },
    {
        { ONLP_FAN_ID_CREATE(FAN_7_ON_FAN_BOARD), "Chassis Fan 3 rear", 0, {}, ONLP_OID_STATUS_FLAG_PRESENT},
        ONLP_FAN_DIR_UNKNOWN,
        ONLP_FAN_CAPS_GET_RPM | ONLP_FAN_CAPS_GET_PERCENTAGE, 0, 0,
    },
    {
        { ONLP_FAN_ID_CREATE(FAN_8_ON_FAN_BOARD), "Chassis Fan 2 rear", 0, {}, ONLP_OID_STATUS_FLAG_PRESENT},
        ONLP_FAN_DIR_UNKNOWN,
        ONLP_FAN_CAPS_GET_RPM | ONLP_FAN_CAPS_GET_PERCENTAGE, 0, 0,
    },
    {
        { ONLP_FAN_ID_CREATE(FAN_9_ON_FAN_BOARD), "Chassis Fan 1 rear", 0, {}, ONLP_OID_STATUS_FLAG_PRESENT},
        ONLP_FAN_DIR_UNKNOWN,
        ONLP_FAN_CAPS_GET_RPM | ONLP_FAN_CAPS_GET_PERCENTAGE, 0, 0,
    },
    {
        { ONLP_FAN_ID_CREATE(FAN_ON_PSU1), "FAN ON PSU1", 0, {}, ONLP_OID_STATUS_FLAG_PRESENT},
        ONLP_FAN_DIR_UNKNOWN,
        ONLP_FAN_CAPS_GET_RPM | ONLP_FAN_CAPS_GET_PERCENTAGE, 0, 0,
    },
    {
        { ONLP_FAN_ID_CREATE(FAN_ON_PSU2), "FAN ON PSU2", 0, {}, ONLP_OID_STATUS_FLAG_PRESENT},
        ONLP_FAN_DIR_UNKNOWN,
        ONLP_FAN_CAPS_GET_RPM | ONLP_FAN_CAPS_GET_PERCENTAGE, 0, 0,
    },
};
